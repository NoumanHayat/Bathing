...
const Screen = ({ navigation }) => {
    return (
        <LinearGradient
            ...
            <ScreenHeader navigation={navigation} title={'Email'} />
            <View style={styles.container}>
                <View>
                    <Text style={styles.title}>Old Email</Text>
                    <AppInput defaultValue={"dolores.chambers@example.com"} />
                    <Text style={{ ...styles.title, marginTop: 23 }}>New Email</Text>
                    <AppInput defaultValue={"nathan.roberts@example.com"} />
                </View>
                <View style={{ justifyContent: 'center', alignItems: 'center' }} >
                    <AppButton
                        onPress={() => { navigation.push('EmailOPT') }}
                        text="Change "
                        style={{
                            width: '100%',
                            marginTop: 30
