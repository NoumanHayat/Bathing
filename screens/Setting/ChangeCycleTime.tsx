...
//                         <Text style={{ color: COLORS.dark, fontSize: 17, fontWeight: 'bold', textAlign: 'center' }}>How long is your Period Average Time?</Text>
//                     </View>
...
//                             <Text style={{ color: COLORS.dark, fontSize: 16, marginTop: "15%", fontWeight: 'bold' }}>Change Period Cycle</Text>
//                         </TouchableOpacity>
//                     </View>
//                 </View>
                ...
                <View style={styles.mainView}>
                    ...
                    <View style={styles.itemsCentered}>
                        <View style={{ marginTop: 284 }}>
                            <Text style={{ color: COLORS.dark, fontSize: 17, fontFamily: FONTS.Black, textAlign: 'center' }}>How long is your Period Average Time?</Text>
                        </View>
                        ...
                        <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                            <TouchableOpacity onPress={() => { navigation.navigate('ChangeCycle') }}>
                                <Text style={{ color: COLORS.dark, fontSize: 16, marginTop: 95, fontWeight: 'bold' }}>Change Period Cycle</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
