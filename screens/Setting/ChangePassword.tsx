...
const Screen = ({ navigation }) => {
    return (
        <LinearGradient
            ...
            <ScreenHeader navigation={navigation} title={'Password'} />
            <View style={styles.container}>
                <View>
                    <Text style={styles.title}>Change Password</Text>
                    <AppInput defaultValue='Old Password' />
                    <AppInput defaultValue='New Password' />
                    <AppInput defaultValue='Re-Enter New Password' />
