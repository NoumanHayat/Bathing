...
import { View, StatusBar, StyleSheet, Text, Image, TextInput } from 'react-native';
            ...
            <View style={styles.mainView}>
                ...
                <View style={styles.itemsCentered}>
                    <View style={{ margin: '10%' }}>
                        <Text style={{ color: COLORS.dark, fontSize: 20,fontFamily:FONTS.Bold, textAlign: 'center' }}>Last Period</Text>
                    </View>
                    <View style={{ margin: '10%',justifyContent:'center',alignItems:'center'}}>
                        <View style={styles.textBoxSign}>
                            <TextInput
                                placeholder="01 May to 05 May"
                    ...
                    <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                        <Text style={{ color: COLORS.dark, fontSize: 16, marginTop: "15%", fontWeight: 'bold' }}>I Can’t Remember</Text>
                    </View>
                </View>
