            ...
            <View style={styles.mainView}>
                ...
                <View style={styles.itemsCentered}>
                    <View style={{ margin: '10%' }}>
                        <Text style={{ color: COLORS.dark, fontSize: 20, fontWeight: FONTS.Black, textAlign: 'center' }}>Do You need a Reminder?</Text>
                    </View>
                ...
                <View style={{ justifyContent: 'center', alignItems: 'center', margin: 10 }}>
                    <IntroButton
                        ...
                        onPress={() => {navigation.navigate('PeriodDashboard')}}
                    />
                </View>
